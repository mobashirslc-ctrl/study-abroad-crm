...
// --- 4. FILE UPLOAD & SUBMIT (WITH AUTO SLIP) ---
const uploadFile = async (file) => {
    if (!file) return "";
    const formData = new FormData();
    formData.append("file", file); formData.append("upload_preset", "ihp_upload");
...
document.getElementById('submitAppBtn').onclick = async () => {
    ...
    try {
        ...
        document.getElementById('rQR').innerHTML = `<img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=SCC-${sPass}" />`;
