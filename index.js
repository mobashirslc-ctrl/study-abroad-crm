...
mongoose.connect(DB_URI).then(() => console.log("IHP CRM: System Secured & Synced")).catch(err => console.log(err));

// --- Schemas (Synced with Admin 20+ Fields) ---
...
// --- Smart Assessment API (Synced with Admin Results) ---
